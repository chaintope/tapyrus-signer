...
```
tapyrus-setup createvss -public_key=1:<static_public_key[1]> -public_key=2:<static_public_key[2]> ... -public_key=n:<static_public_key[n]> -private_key=<static_private_key[i]> -nonce=<networkid> -threshold=<t>
