...
This document describes how to set up new Tapyrus Signer Network. This document is a part 
...
Each signer generates node key pair using `tapyrus-setup createkey` independently.
...
Here describes steps for generating genesis block proof. 
