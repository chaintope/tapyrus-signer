...
```
tapyrus-setup sign -block_vss=1:<block_vss[1, i]> -block_vss=2:<block_vss[2, i]> ... -block_vss=t:<block_vss[n, i]>   -aggregated_public_key=<aggregated_public_key> -nodesecret=<node_secret_share[i]> -private_key=<node_private_key[i]> -block=<block>
