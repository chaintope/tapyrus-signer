...
| node_secret  | hex string          | secret value generated in Step 4 in setup                                                    |
...
```
curl -X POST "http://127.0.0.1:3000/update_federation" -H "accept: */*" -H "Content-Type: application/json" -d "{\"method\":\"update_federation\",\"id\":1,\"jsonrpc\":\"2.0\",\"params\":{\"block_height\":99999,\"threshold\":2,\"node_secret\":\"0102030405060708090a0b0c0d0e0ff0f1f2f3f4f5f6f7f8f9fafbfcfdfeff\",\"public_keys\":[\"03842d51608d08bee79587fb3b54ea68f5279e13fac7d72515a7205e6672858ca2\",\"03e568e3a5641ac21930b51f92fb6dd201fb46faae560b108cf3a96380da08dee1\",\"02a1c8965ed06987fa6d7e0f552db707065352283ab3c1471510b12a76a5905287\"]}}"
```
